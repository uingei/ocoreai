...
actor PagedKVCache {
    ...
    public init(
        ...
        self.blockPool = BlockPool(config: poolConfig, logger: logger)
    ...
    public func sessionInfo(sessionId: String) -> SessionInfo? {
    ...
    /// 获取所有 session 的信息。
    public func allSessionInfo() -> [SessionInfo] {
        sessions.values.map {
            SessionInfo(
    ...
    /// 获取内部 BlockPool 统计信息。
    public func poolStats() async -> BlockPoolStats {
    ...
    public func getMemoryBytes() async -> Int {
