...
enum TicketCategory: String, Codable, Sendable {
    case support = "support"        // Technical support request
    case complaint = "complaint"    // Customer complaint
    case inquiry = "inquiry"        // General inquiry
    case refund = "refund"          // Refund/cancellation request
    case feedback = "feedback"      // Product feedback/suggestion
    case other = "other"            // Unclassified
}

/// Classification result with confidence score.
struct ClassificationResult: Sendable, Codable {
...
struct NaturalLanguageClassifier: Sendable {
