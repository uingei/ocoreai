...
enum CorrectionPhase: String, Sendable, Codable {
...
struct CorrectionTrace: Sendable, Codable {
...
struct RuleCritiqueResult: Sendable {
...
struct SelfCorrectionPipeline: Sendable {
...
extension IntentAction {
    ...
    func examplesForCorrection(intentAction: IntentAction) -> [String]? {
        switch self {
        case .askQuestion:
            return [
