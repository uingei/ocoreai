...
actor SQLiteStore {
    ...
    nonisolated var dbPathDescription: String { dbPath }
...
extension SQLiteError: LocalizedError {
    var errorDescription: String? {
        switch self {
        case .notConnected: return "SQLite database not connected"
        ...
        case .schemaMigrationFailed(let detail): return "Schema migration failed: \(detail)"
        }
    }
}
