...
extension ComplexityAnalyzer {
    ...
    func sessionBaseline(sessionId: String) -> Double? {
        ...
        guard let scores = scores, !scores.isEmpty else { return nil }
...
extension ComplexityAnalyzer {
    ...
    private func scoreIntent(_ input: String) -> Double {
        ...
        var score: Double = 0.5 // neutral prior
...
extension ComplexityAnalyzer {
    ...
    private func compositeScore(
        ...
        let wLength: Double = 0.30
        let wIntent: Double = 0.45
        let wHistory: Double = 0.25
...
struct ComplexityScore: Sendable {
    ...
    var thinkingBudgetTokens: Int {
        switch band {
        case .simple: return 0        // direct answer
        case .medium: return 1_024    // standard reasoning scaffold
        case .complex: return 4_096   // deep reasoning + verification
        }
    }
}

/// Complexity classification band.
enum ComplexityBand: String, Sendable {
