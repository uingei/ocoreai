...
final class SystemState {
	...
	private var bridge: MCPBridge? {
		OcoreaiEngine.shared.activeMCPBridge
	}

	private var registry: ToolRegistry? {
		OcoreaiEngine.shared.activeToolRegistry
	}

	private var trail: AuditTrail? {
		OcoreaiEngine.shared.activeAuditTrail
	}

	private var analyzer: ComplexityAnalyzer? {
		OcoreaiEngine.shared.activeComplexityAnalyzer
	}
