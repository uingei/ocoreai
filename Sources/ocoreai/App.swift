...
public final class OcoreaiEngine {
    ...
    private init() {
        self.logger = Logger(label: "ocoreai")
    }
    ...
    public func stop() async {
        ...
        do {
            try await withTimeout(seconds: 30) { [weak self] in
                ...
                await self.enginePool?.shutdown()
            }
