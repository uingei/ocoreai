            ...
            "Data": [
                "Models": [
                    [
                        ...
                        "LicenseName": "mit", "StorageSize": "2GB", "CreatedTime": 1_700_000_000,
                        "IsHot": 1,
                    ]
                ],
                "TotalCount": 1,
...
struct HFHubModelTests {
    ...
    func mlxCompatible() {
        let withMF = HFHubModel(
            id: "a", displayName: "a", tags: ["mlx"], likes: 0,
            pipelineTag: nil, lastModified: nil, downloads: nil, sizeBytes: nil)
        let withMX = HFHubModel(
            id: "b", displayName: "b", tags: ["MLX"], likes: 0,
            pipelineTag: nil, lastModified: nil, downloads: nil, sizeBytes: nil)
        let without = HFHubModel(
            id: "c", displayName: "c", tags: ["pytorch"], likes: 0,
            pipelineTag: nil, lastModified: nil, downloads: nil, sizeBytes: nil)
    ...
    func nameComponents() {
        let model = HFHubModel(
            id: "mlx-community/Llama-3.1-8B", displayName: "Llama",
    ...
    func nameComponentsBare() {
        let model = HFHubModel(
            id: "justname", displayName: "justname",
            tags: [], likes: 0, pipelineTag: nil, lastModified: nil,
            downloads: nil, sizeBytes: nil)
